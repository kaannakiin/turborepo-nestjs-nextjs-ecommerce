...
import { Locale, VariantGroupType } from "@repo/database/client";
import { createId, slugify, UseFormReset, UseFormSetValue } from "@repo/shared";
...
interface CreatableSelectProps extends Omit<InputBaseProps, "rightSection"> {
  ...
  allVariants: VariantGroupZodType[];
  isLoading: boolean;
}
