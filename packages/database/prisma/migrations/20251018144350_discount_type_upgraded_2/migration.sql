/*
  ...
  - The values [PERCENTAGE_MAX_DISCOUNT] on the enum `DiscountType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "DiscountType_new" AS ENUM ('PERCENTAGE', 'PERCENTAGE_GROW_QUANTITY', 'PERCENTAGE_GROW_PRICE', 'FIXED_AMOUNT', 'FIXED_AMOUNT_GROW_QUANTITY', 'FIXED_AMOUNT_GROW_PRICE', 'FREE_SHIPPING', 'BUY_X_GET_Y');
